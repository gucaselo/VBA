...
Dim CurrentProgress As Double, ProgressPercentage As Double, BarWidth As Long, Bar2Width As Long, TotalProgress As Double
Dim PercentColumn As Long

Application.ScreenUpdating = False 'This helps speed up the process and only show results.
WSCount = ActiveWorkbook.Worksheets.Count 'Count amount of Worksheets in this workbook. To be used for progress bar calculation.
...
Do Until i > cr And j > WSCount 'Progress Bar loop
    ...
    For j = 1 To WSCount 'Run script on all worksheets
        ...
        'Worksheets completed. Overall completed.
